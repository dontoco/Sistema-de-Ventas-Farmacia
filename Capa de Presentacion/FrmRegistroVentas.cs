...
namespace Capa_de_Presentacion
{
    public partial class FrmRegistroVentas : Form
    {
                        ...
                        if (Convert.ToInt32(txtCantidad.Text) >= 0){
                            if (Convert.ToInt32(txtCantidad.Text) <= Convert.ToInt32(txtStock.Text)){
                                if (txtIgv.Text.Trim() != ""){
                                    ...
                                    MessageBox.Show("Por Favor Ingrese I.V.A.","Sistema de Ventas Farmacia las Lomas",MessageBoxButtons.OK,MessageBoxIcon.Error);
                                    txtIgv.Focus();
                                }
                            }else{
                                MessageBox.Show("Stock Insuficiente para Realizar la Venta.", "Sistema de Ventas. Farmacia Las Lomas", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                            }
                        }else{
                            MessageBox.Show("Cantidad Ingresada no Válida.", "Sistema de Ventas Farmacias Las lomas.", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                            txtCantidad.Clear();
                            txtCantidad.Focus();
                        }
                    }
                    else {
                        MessageBox.Show("Por Favor Ingrese Cantidad a Vender.", "Sistema de Ventas Farmacias Las lomas.", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                        txtCantidad.Focus();
                    }
                }
                else {
                    MessageBox.Show("Por Favor Busque el Producto a Vender.", "Sistema de Ventas.Farmacias Las Lomas", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                }
            }else{
                MessageBox.Show("Por Favor Busque el Cliente a Vender.", "Sistema de Ventas Farmacias Las Lomas", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        private void LlenarGrilla() {
            ...
            dataGridView1.Rows.Add();
            dataGridView1.Rows[lst.Count + 2].Cells[3].Value = "      I.V.A.        %";
        ...
        private void btnRegistrarVenta_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0){
                if (Convert.ToString(dataGridView1.CurrentRow.Cells[2].Value) != ""){
                    ...
                    MessageBox.Show("No Existe Ningún Elemento en la Lista.", "Sistema de Ventas.Farmacia Las Lomas", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else {
                MessageBox.Show("No Existe Ningún Elemento en la Lista.","Sistema de Ventas.Farmacia las lomas",MessageBoxButtons.OK,MessageBoxIcon.Error);
        ...
        private void lblNroCorrelativo_Click(object sender, EventArgs e)
        {
